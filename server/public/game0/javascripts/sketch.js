...
function preload() {
  myRed = loadImage('game0/images/Invader_1-514.png');
  myGreen = loadImage('game0/images/green.png');
  myPurple = loadImage('game0/images/purple.png');
  myBlue = loadImage('game0/images/Invader_blue.png');
  // ellipse_shot = loadImage('game0/images/ellipse_shot.png');
  //ship2 = loadImage('game0/images/spaceship.png');
  explosion = loadImage('game0/images/explosion-1.png');
  flower = loadImage('game0/images/flower.png');
  trump1 = loadImage('game0/images/trump1.png');
  trump2 = loadImage('game0/images/trump2.png');
  gameOver = loadImage('game0/images/game_over.png');
  youSuck = loadImage('game0/images/you_suck.png');
  star1 = loadImage('game0/images/star1.png');
  rock1 = loadImage('game0/images/rock1.png');
  rock2 = loadImage('game0/images/rock2.png');
  rock3 = loadImage('game0/images/rock3.png');
  rock4 = loadImage('game0/images/rock4.png');
  rockmonster = loadImage('game0/images/rock_monster.png');
  crabman = loadImage('game0/images/enemy1.png');
  minionEn = loadImage('game0/images/crabman.png');
  gif = loadGif('game0/images/big_boss1.gif');
  explode_fire = loadGif('game0/images/Explode_fire.gif');
  whiteGlow = loadImage('game0/images/white_glow.png');
  whiteCrab = loadImage('game0/images/crabman_white.png');
  projectile1 = loadImage('game0/images/proj1.png');
...
function draw() {
  ...
  if (invaders.length === 0) {
    if (waveNum === 1) {
      ...
      invaderWave(11, 3)
      waveNum++;
    } else if (waveNum === 4 && drop2Count >= 1) {
  ...
  for (var i = 0;i < fires.length; i++){
    ...
    if (minions[0].y > 10) {
      for (var l = 0;l < minions.length; l++){
        //console.log(fires[i].hits(minions[l]))
  ...
  ///enemy fire
    ...
    for (var j = 0;j < invaders.length; j++){
       if (invaders[j].y > 380*heightRata) {
        ship.blowup();
        endScreen++;
      }
    }
